...
class Circle extends Shape {
    ...
    render() {
        return `<svg version="1.1"
          ...
          <text x="44" y="80" color="${this.textColor}">${this.text}</text>
...
class Triangle extends Shape {
    ...
    render() {
        return `<svg version="1.1"
          ...
          <text x="122" y="120" font-size="30" color=${this.textColor}>${this.text}</text>
...
class Square extends Shape {
    ...
    render() {
        ...
        <text x="21.5" y="60" font-size="30" color="${this.textColor}">${this.text}</text>
